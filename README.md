...
5. Inside the prefab on your avatar, parent the `VRCGraffiti/GraffitiAnchor/GraffitiCanHolder` to the body part you want on your avatar (for hand use the wrist target).
6. Adjust the location/rotation of the `VRCGraffiti/GraffitiAnchor/GraffitiCanHolder/VRCSprayCanModel` in a way that makes sense for your avatar (make sure the can is facing the right way). Remember to disable `VRCGraffiti/GraffitiAnchor/GraffitiCanHolder` once your done.
